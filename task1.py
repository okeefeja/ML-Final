...
postpre_bike_usage = pd.merge(post_pandemic_bike_usage, temperature_df, left_on='TIME', right_on='DATE', how='left')
...
test_data = pandemic_bike_usage[['TIME', 'PERCENT_AVAILABLE_BIKE_STANDS', 'daily_average_temperature', 'daily_average_rain']]
